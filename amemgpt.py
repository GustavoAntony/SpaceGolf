...
while True:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            ball_velocity = (force_normalized[0]*force_magnitude/BALL_MASS*0.003*(-1), force_normalized[1]*force_magnitude/BALL_MASS*(-1)*0.003)
    ...
    if pygame.mouse.get_pressed()[0]:
        ...
        endpos2 = ball_pos+(ball_pos-start_pos2)
        pygame.draw.line(surface= window, color='white', start_pos= (ball_pos),end_pos=endpos2)
